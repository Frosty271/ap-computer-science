public class textLab03 {
	public static void main(String args[]){
		...
		double R = ( (inputAnnualRate/100)/12);  //
		...
		double roundedMonthlyPayment =  (double)Math.round( monthlyPayment * 100)/100;//We must cast here because Math.round returns an int. Deviding by 100 leads to truncation.
